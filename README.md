...
Real-time WebRTC voice agent service for Orchet. Long-lived Pipecat orchestration on Fly.io. Per **VOICE-ARCHITECTURE-1 v6**.

**Status:** Phase 1 — FastAPI + Pipecat echo skeleton.
...
| 1 — orchet-voice skeleton + Fly.io echo + India probe | 🚧 In progress (issue [#4](https://github.com/Orchet-AI/orchet-voice/issues/4)) | [Phase 1 brief](docs/briefs/VOICE-PHASE-1-CODEX-BRIEF.md), [Probe result](docs/phase-1-india-probe-result.md) |
...
| Fly org token `FLY_API_TOKEN` (expires 2027-05-11) | ✅ provided for Phase 1 deploy |
...
The authoritative architecture document is **[docs/architecture/VOICE-ARCHITECTURE-1.md](docs/architecture/VOICE-ARCHITECTURE-1.md)** (v6, approved 2026-05-10).
